...
@Component({
  selector: 'app-componentless-overview-panel',
  template: `
    <article class="componentless-panel">
      <p class="eyebrow">Overview Child Route</p>
      <h3>{{ context().workspaceId }} overview</h3>
      <p>
        This child route renders a component, but its parent route only groups
        the URL segment, params, and data.
      </p>
      <dl>
        <div>
...
export class ComponentlessOverviewPanel {
